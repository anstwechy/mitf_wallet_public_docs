...
- **Operations & continuity hub:** disaster recovery template, incident playbooks, performance tuning, observability hooks, data lifecycle, and CI/CD patterns are under [**Operations**](operations/production-deployment.md) in the sidebar (see also [documentation roadmap](meta/documentation-roadmap.md)).
